 ...
 *
 * Static by design. Motion (spec §5's 20s master loop) is a later pass and
 * belongs in globals.css inside @media (prefers-reduced-motion: no-preference).
 */
export function AuthShapes() {
  return (
    <svg
      ...
      aria-hidden="true"
      className="pointer-events-none absolute inset-0 size-full text-on-board"
    >
      <defs>
      ...
      {/* The grid gives the glass something to sit against. */}
      <rect width="600" height="800" fill="url(#auth-grid)" opacity="0.07" />
